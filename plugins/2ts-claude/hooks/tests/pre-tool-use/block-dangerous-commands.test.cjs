...
const { PATTERNS, LEVELS, SAFETY_LEVEL, checkCommand } = require('../../pre-tool-use/block-dangerous-commands.cjs');

const SCRIPT_PATH = path.join(__dirname, '../../pre-tool-use/block-dangerous-commands.cjs');
